...
@Component({
  selector: 'app-adminselleritemspage',
  templateUrl: './adminselleritemspage.component.html',
  styleUrls: ['./adminselleritemspage.component.css']
})
export class AdminselleritemspageComponent implements OnInit {
  ...
  getItemsbyid(){
    ...
    this.service.getItemBySellerId(this.sellerid).subscribe(
      data => {
